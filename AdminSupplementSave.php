    ...
    <div id="wrapper">
        ...
        <div class="row" style="margin-bottom: 20px; text-align: left">
            <div class="col-lg-12">
                ...
                <input type="submit" class="btn btn-sm btn-warning" name="gotype" value="查看補充資料類別" >
...
<div class="col-lg-12">
    ...
    <font size="6"><strong style="background:white">暫存補充資料總覽</strong></font>
    ...
    <div class="container-fluid">
        ...
        <div class='wrapper'>
            ...
            if (!($_GET["type"]) || $_GET["type"]=="all")
            {
                ...
                $sqlresult = "SELECT * FROM supplements  where save='1' order by spt_id Limit $start , $per";
            ...
            {
                $sqltype = "SELECT * FROM supplements WHERE spmtypename ='$_GET[type]' && save='1' order by spt_id   ";
                $resulttype= mysqli_query($db_link, $sqltype);
                ...
                $sqlresultsrc = "SELECT * FROM supplements WHERE spmtypename ='$_GET[type]' && save='1' order by spt_id Limit $start , $per";
                ...
                echo "<center>";
                echo '共 ' . $date_nums . ' 筆-在 ' . $page . ' 頁-共 ' . $pages . ' 頁';
                echo "<br/><a href=?type=$_GET[type]&gotype=查看補充資料類別&page=1>首頁</a> ";
                echo "第 ";
                for ($i = 1; $i <= $pages; $i++) {
                    if ($page - 10 < $i && $i < $page + 10) {
                        echo "<a href=?type=$_GET[type]&gotype=查看補充資料類別&page=$i>" . $i . "</a> ";
                    }
                }
                echo " 頁 <a href=?type=$_GET[type]&gotype=查看補充資料類別&page=$pages>末頁</a>";
                echo "</center>";
