...
<div id="wrapper">
 ...
 <div class="col-lg-12">
			...
			<font size="6"><strong style= "background:white" >底部標語管理</strong></font>
...
<?php			if(isset($_POST["slogans"]))
                {
					if($_POST["slogant"]==null){
						echo "<script>alert('更改內容不能為空值');location.href='AdminfootSloganEdit.php'</script>";
					}
					else{
						$sqliit="UPDATE `slogan` set `slogantext`='$_POST[slogant]' where `sloganid` = '3'";
						mysqli_query($db_link, $sqliit);
						echo "<script>alert('更改成功');location.href='AdminfootSloganEdit.php'</script>";
					}
