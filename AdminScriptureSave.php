...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class='wrapper'>
            ...
            {
                $sqltype = "SELECT * FROM scripture WHERE typename ='$_GET[type]' && save='1' order by t_id   ";
                $resulttype= mysqli_query($db_link, $sqltype);
                ...
                $sqlresultsrc = "SELECT * FROM scripture WHERE typename ='$_GET[type]' && save='1' order by t_id Limit $start , $per";
