    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class='wrapper'>
                ...
                echo "<table border=1 cellspacing=0  width=100% style=font-size:22px;line-height:50px; >";
				 echo "<tr align=left>";
                ...
                $sqlmember= "SELECT * FROM members where authority = 0";
                $result0= mysqli_query($db_link,$sqlmember);
                ...
                $sqlresult = "SELECT * FROM members where authority = 0 Limit $start , $per";
                $memberresult[$start] = mysqli_query($db_link, $sqlresult);
                $memberresult[$page] = mysqli_query($db_link, $sqlresult);
