...
<div id="wrapper">
 ...
 <div class="col-lg-12">
			...
			<font size="6"><strong style= "background:white" >置頂公告管理</strong></font>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class='wrapper'>
                ...
                $sql = "SELECT * FROM posts where top='1' order by date DESC";
                ...
                $sqlkeep = "SELECT * FROM posts where top='1' order by date DESC";
                ...
                $sqlresult = "SELECT * FROM posts where top='1' order by date DESC Limit $start , $per";
                ...
                while($row2=$result2->fetch_assoc()) {
                    ...
                    if (isset($_POST["$row2[p_id]+2"])) {
					 ...
					 if (isset($_POST["$row2[p_id]+3"])) {
                        $_SESSION["delete_p_id"]=$row2["p_id"];
                        $sql_detop="update posts set top='0'  WHERE posts.p_id = $_SESSION[delete_p_id]";
                        mysqli_query($db_link, $sql_detop);
                        echo "<script>alert('取消置頂成功!');location.href='AdminPostsTop.php'</script>";
                    }
                }
